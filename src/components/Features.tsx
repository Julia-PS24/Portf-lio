  ...
  return <section id="features" className="section-padding">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature, index) => <Card key={index} className="bg-card-gradient border-slate-700 card-hover animate-fade-in" style={{
        ...
        <div className="bg-gradient-to-r from-clareia-deep-purple/30 to-clareia-dark-blue/30 rounded-3xl p-8 md:p-12 text-center animate-fade-in">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">Junte-se ao Clareia para alcançar seus objetivos acadêmicos.</p>
